<div class="row">
     <div class="col-md-2">
          <select name="account" class="form-control m-b">
               <option>Upload a theme</option>
               <option>Download a theme</option>
     ...
     <div class="col-md-6">
          <div class="input-group">
               ...
               <span class="input-group-btn">
                    <button class="btn btn-white" type="button">Select File</button>
               </span>
          </div>
     </div>
               ...
               <tbody>
                    <tr>
                         ...
                         <td class="text-right v-middle">
                              ...
                              <a href="#" class="btn btn-info">Save to your themes <i class="icon-chevron-right"></i></a>
                         </td>
                    </tr>
               </tbody>
          </table>
