        ...
        <section class="panel">
            <header class="panel-heading bg-light">
                ...
                <ul class="nav nav-tabs">
                    <li><a href="#messages-1" data-toggle="tab"><i class="icon-bar-chart text-default"></i> Your Sites</a></li>
                    ...
                    <li class="active"><a href="#new-site" data-toggle="tab" class=""><i class="icon-plus text-default"></i> New Site</a></li>
                </ul>
            ...
            <div class="panel-body no-padder">
                <div class="tab-content">              
                    ...
                    <div class="tab-pane active" id="new-site">
